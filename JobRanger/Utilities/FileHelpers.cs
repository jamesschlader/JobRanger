...
namespace JobRanger.Utilities
{
    public class FileHelpers
    {
            ...
            ModelStateDictionary modelState)
        {
            ...
            // a display name.
            MemberInfo property =
                typeof(Models.FileUpLoad).GetProperty(
            ...
            Debug.WriteLine(formFile.ContentType);
            Debug.WriteLine(formFile.Length);

         /*   if (formFile.ContentType.ToLower() != "text/plain" || formFile.ContentType.ToLower() != "application/pdf")
            {
...
*/
            ...
            else
            {
                ...
                // new UTF8Encoding(...) to new UTF32Encoding().  new UTF8Encoding(encoderShouldEmitUTF8Identifier: false,
               ...
               Stream fileContents = formFile.OpenReadStream();

                    using (
                        var reader = new MemoryStream())
                    {
                        fileContents.CopyTo(reader);
